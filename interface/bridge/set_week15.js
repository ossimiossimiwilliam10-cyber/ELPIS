...
db.transaction(() => {
  // 1. Update Exam Dates
  updateExamDate("Introduction aux Systèmes Electroniques", "2026-12-15");
  updateExamDate("Mécanique du solide", "2026-12-17");
  updateExamDate("Architecture des systèmes d'exploitation", "2026-12-18");

  // 2. Update Dates for CMs
  const datesCM = [
    { nom: "Programmation", cm: 'CM 5', date: '2026-12-14' },
    { nom: "Electromagnétisme", cm: 'CM 7', date: '2026-12-18' }
  ];
  ...
  const datesTD = [
    { nom: 'Programmation', td: 'TD 5', date: '2026-12-16' }
  ];
  ...
  const datesTP = [
    { nom: 'Analyse', tp: 'TP 6', date: '2026-12-16' },
    { nom: 'Algèbre', tp: 'TP 6', date: '2026-12-17' }
  ];
...
console.log('Finished updating week 15 schedule.');
