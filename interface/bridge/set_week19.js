...
db.transaction(() => {
  // 1. Update Exam Dates
  updateExamDate("Electromagnétisme", "2027-01-11");
  updateExamDate("Programmation", "2027-01-13");
  updateExamDate("Signal et technologie en santé (Santé)", "2027-01-13");
  updateExamDate("Aspects médicaux-légaux en santé (Santé)", "2027-01-13");

})();

console.log('Finished updating week 19 schedule.');
