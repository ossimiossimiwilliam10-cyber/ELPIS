...
db.transaction(() => {
  // 1. Update Exam Dates
  updateExamDate("Introduction aux Systèmes Electroniques", "2027-01-06");
  updateExamDate("Programmation", "2027-01-06");
  updateExamDate("Algèbre", "2027-01-07");
  updateExamDate("Analyse", "2027-01-07");

  // 2. Ensure structures exist
  ensureExercices("Construction Mécanique", "TP", 4);
  ensureExercices("Electromagnétisme", "TD", 7);

  // 3. Update Dates for TDs
  const datesTD = [
    { nom: 'Electromagnétisme', td: 'TD 7', date: '2027-01-06' }
  ];
  ...
  const datesTP = [
    { nom: 'Construction Mécanique', tp: 'TP 4', date: '2027-01-04' },
    { nom: 'Programmation', tp: 'TP 5', date: '2027-01-05' }
  ];
...
console.log('Finished updating week 18 schedule.');
