...
function CoursPage() {
  ...
  const addTDManuel = (lIndex, sIndex, uIndex, mIndex) => {
    mutateAndSave(draft => {
      ...
      m.listeTD.push({ titre: "Nouvel Exercice de TD", dernierePratique: "", nombrePratiques: 0, notes: "", dateAjout: new Date().toISOString() });
    });
  };
  ...
  const addTPManuel = (lIndex, sIndex, uIndex, mIndex) => {
    mutateAndSave(draft => {
      ...
      m.listeTP.push({ titre: "Nouvel Exercice de TP", dernierePratique: "", nombrePratiques: 0, notes: "", dateAjout: new Date().toISOString() });
    });
  };
  ...
  const addAnnaleManuel = (lIndex, sIndex, uIndex, mIndex) => {
    mutateAndSave(draft => {
      ...
      m.listeAnnales.push({ titre: "Nouvelle Annale", dernierePratique: "", nombrePratiques: 0, notes: "", dateAjout: new Date().toISOString() });
    });
  };
