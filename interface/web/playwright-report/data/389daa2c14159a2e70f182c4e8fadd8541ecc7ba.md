...
- Name: elpis.spec.js >> ELPIS E2E Tests >> devrait naviguer vers la page de Configuration
- Location: tests\elpis.spec.js:34:3
...
Call log:
  - waiting for locator('nav a:has-text("Configuration")')
