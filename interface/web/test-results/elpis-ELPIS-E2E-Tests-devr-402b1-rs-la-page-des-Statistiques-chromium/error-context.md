...
- Name: elpis.spec.js >> ELPIS E2E Tests >> devrait naviguer vers la page des Statistiques
- Location: tests\elpis.spec.js:26:3
...
Call log:
  - waiting for locator('nav a:has-text("Statistiques")')
