...
- **Int�gration du R�glement Universitaire** : Lorsqu'une r�gle de scolarit� (r�glement des �tudes, MECC) est fournie (texte ou image), l'agent DOIT toujours consid�rer deux axes d'int�gration pour ELPIS :
